<template lang="pug">
section.my-5.support.blueGrey2
    v-container
        hs Support
        v-layout(justify-space-between fill-height :wrap="$vuetify.breakpoint.smAndDown")
            v-flex(xs12 md4 :class="{'mr-3': $vuetify.breakpoint.mdAndUp, 'mb-2': $vuetify.breakpoint.smAndDown}")

    ...
    section.abstract
        v-container.py-0
            ...
            .text-xs-center.text-sm-left.py-2
                button-with-arrow(color="themeColor1" outline :dark="true" :block="false" :href="this.$i18n.locale + '/schedule'" ) {{ $t("home.conference.timetables") }}
                button-with-arrow(color="themeColor1" outline :dark="true" :block="false" :href="this.$i18n.locale + '/sessions'") {{ $t("home.conference.sessions") }}
